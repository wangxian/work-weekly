...
//	$("#username").formValidator({onshow:"请输入用户名",onfocus:"用户名至少6个字符,最多10个字符,英文",oncorrect:"该用户名可以注册"})
    ...
    <div class="set-wrap">
        ...
        <div class="wrap-inner">
    		...
    		<div class="set-area-int">
            	...
            	<label>
            		<p>登录名：<span>(只读，不能修改)</span></p>
            		<input name="username" id="username" class="input-box site-box-w" type="text"  value="<?php echo $this->user_info['username'];?>" readonly="readonly" />
            	</label>
            	</div>
            	<div class="site-info-a">
            	<label>
            		<p>密码：<span>(如果不修改，请留空)</span></p>
            	...
            	<label>
					...
					<option value="<?php echo $v['id'];?>" <?php echo Html::selected($v['id'], $this->user_info['group_id']);?>><?php echo $v['name'];?></option>
					<?php endforeach;?>
					</select>
            	</label>
            	</div>
            	...
            	<label>
            		...
            		<input name="realname" type="text" id="realname"  class="input-box site-box-w" value="<?php echo $this->user_info['realname'];?>" />
            	</label>
            	</div>
            	<div class="site-info-a">
	            	<p>性别：<span></span></p>
	            	<label><input name="sex" type="radio" value="1" <?php echo Html::checked($this->user_info['sex'], 1);?> />男</label>&nbsp;&nbsp;
	            	<label><input name="sex" type="radio" value="0" <?php echo Html::checked($this->user_info['sex'], 0);?> />女</label>
            	</div>
            	<div class="site-info-b">
            	<label>
            		<p>电话：<span></span></p>
            		<input name="telphone" id="telphone" class="input-box site-box-w" type="text" value="<?php echo $this->user_info['telphone'];?>" />
            	</label>
            	</div>
        	</div>
        </div>
