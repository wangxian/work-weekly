...
<body>
<div class="main-wrap">
    <div class="path"><span class="path-icon"></span>当前位置：课程价格<span> &gt; </span>添加</div>
    <div class="set-wrap">
        <form action="" method="post" name="form1" id="form1" onsubmit="return $.formValidator.pageIsValid('1')">
        <div class="wrap-inner">
            <h4 class="main-title">课程价格添加</h4>
            <div class="set-area-int">

                <div class="site-info-a">
                <label>
                    <p>项目名称：<span>(课程项目名称，如：常规单次卡)</span></p>
                    <input name="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="period" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="price" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="expires" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    <p>说明：<span></span></p>
                    <textarea name="intro" cols="100" rows="12"></textarea>
                </label>
                </div>
