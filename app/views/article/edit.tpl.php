...
<body>
<div class="main-wrap">
  <div class="path"><span class="path-icon"></span>当前位置：文章管理<span> &gt; </span>文章编辑</div>
    <div class="set-wrap">
      <form action="" method="post" name="form1" id="form1" onsubmit="return $.formValidator.pageIsValid('1')" enctype="multipart/form-data">
        <div class="wrap-inner">
          <h4 class="main-title">文章编辑</h4>
        <div class="set-area-int">

              <div class="site-info-a">
              <label>
                <p>标题：<span>(文章标题)</span></p>
                <input name="title" id="title" class="input-box site-box-w" type="text" value="<?php echo $this->data['title'];?>" />
              </label>
              </div>
              ...
              <div class="site-info-a">
                ...
                <select name="site_id">
                  ...
                  <option value="<?php echo $v['id'].'|'.$v['title'];?>" <?php echo Html::selected($v['id'], $this->data['site_id']); ?> ><?php echo $v['title']; ?></option>
                  <?php endforeach;?>
                </select>
              </div>
              ...
              <div class="site-info-a">
                ...
                <input name="tags" id="tags" class="input-box site-box-w" type="text" value="<?php echo $this->data['tags'];?>" />
              </div>

              <div class="site-info-a">
                <p>作者：<span>(文章的作者.)</span></p>
                <input name="author" id="author" class="input-box site-box-w" type="text" value="<?php echo $this->data['author'];?>" />
              </div>

              <div class="site-info-a">
              <label>
                <p>背景图：<span>(作为网站文章的背景图，尺寸：460x260, 不修改，可以不用新上传)</span></p>
              ...
              <label>
                ...
                <textarea id="summary" class="" name="summary" cols="60" rows="8"><?php echo $this->data['summary'];?></textarea>
              </label>
              </div>
              ...
              <label>
                ...
                <textarea id="content" class="" name="content" cols="100" rows="10"><?php echo stripslashes($this->data['content']);?></textarea>
              </label>
              </div>
