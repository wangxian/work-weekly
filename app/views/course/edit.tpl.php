...
<body>
<div class="main-wrap">
    <div class="path"><span class="path-icon"></span>当前位置：课程安排<span> &gt; </span>修改</div>
    <div class="set-wrap">
        <form action="" method="post" name="form1" id="form1" onsubmit="return $.formValidator.pageIsValid('1')">
        <div class="wrap-inner">
            <h4 class="main-title">课程修改</h4>
            <div class="set-area-int">

                <div class="site-info-a">
                <label>
                    <p>时间段：<span>(课程时间段, 例如：15:00 ~ 16:30)</span></p>
                    <input name="dtime" value="<?php echo $this->data["dtime"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w1" value="<?php echo $this->data["w1"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w2" value="<?php echo $this->data["w2"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w3" value="<?php echo $this->data["w3"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w4" value="<?php echo $this->data["w4"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w5" value="<?php echo $this->data["w5"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w6" value="<?php echo $this->data["w6"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
                ...
                <label>
                    ...
                    <input name="w7" value="<?php echo $this->data["w7"];?>" id="title" class="input-box site-box-w" type="text" />
                </label>
                </div>
