            ...
            <div class="set-area-int">
                ...
                <label>
                    ...
                    <select name="news_type">
                      <option value="1" <?php echo Html::selected($this->data["news_type"], 1); ?> >新闻动态</option>
                      <option value="-1" <?php echo Html::selected($this->data["news_type"], -1); ?> >活动公告</option>
                      <option value="0" <?php echo Html::selected($this->data["news_type"], 0); ?> >二者都是</option>
                    </select>
                </label>
                </div>
                ...
                <label>
                  ...
                  <div id="reupload"></div>
                  <input type="hidden" name="banner" id="uploadpic" value="<?php echo $this->data["banner"];?>" />
                  <div id="divFileProgressContainer"></div>
                  <div id="thumbnails"><img src="<?php echo $this->data["banner"];?>" style="margin-top:20px;" /></div>
                ...
                <label>
                  <p>英文摘要：<span></span></p>
                  <textarea name="intro_en" cols="100" rows="12"><?php echo $this->data["intro_en"];?></textarea>
                </label>
                </div>
                ...
                <label>
                  <p>中文摘要：<span></span></p>
                  <textarea name="intro_zh" cols="100" rows="12"><?php echo $this->data["intro_zh"];?></textarea>
                </label>
                </div>
                ...
                <label>
                  ...
                  <textarea id="content" class="" name="content" cols="100" rows="20"><?php echo $this->data["content"];?></textarea>
                </label>
                </div>
